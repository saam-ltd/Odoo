!function (e, t) {
    ...
    return function (e) {
        ...
        function s(e, t) {
            ...
            if (n = t.header, new RegExp("<([A-Za-z][A-Za-z0-9]*)\\b[^>]*>(.*?)</\\1>").test(n)) r.innerHTML = t.header; else {
                var o = document.createElement("h1"), i = document.createTextNode(t.header);
        ...
        function u(e, t) {
            try {
                if (e.focus(), o.isEdge() || o.isIE()) try {
        ...
        var f = {
            send: function (e, t) {
                ...
                n.onload = function () {
                    ...
                    } else o.isFirefox() ? setTimeout((function () {
                        return u(n, e)
                    }), 1e3) : u(n, e)
                }
            }
            ...
            if (e.base64) {
                ...
                r.responseType = "arraybuffer", r.addEventListener("error", (function () {
                    p(e), e.onError(r.statusText, r)
                })), r.addEventListener("load", (function () {
                    if (-1 === [200, 201].indexOf(r.status)) return p(e), void e.onError(r.statusText, r);
                    m(e, t, r.response)
        ...
        var h = function (e, t) {
            var n,
                r = "object" === y(n = e.printable) && n && (n instanceof HTMLElement || 1 === n.nodeType) ? e.printable : document.getElementById(e.printable);
            r ? (e.printableElement = function o(e, t) {
                for (var n = e.cloneNode(), r = Array.prototype.slice.call(e.childNodes), i = 0; i < r.length; i++) if (-1 === t.ignoreElements.indexOf(r[i].id)) {
                    var a = o(r[i], t);
                    n.appendChild(a)
                }
                t.scanStyles && 1 === e.nodeType && n.setAttribute("style", function (e, t) {
                    for (var n = "", r = (document.defaultView || window).getComputedStyle(e, ""), o = 0; o < r.length; o++) (-1 !== t.targetStyles.indexOf("*") || -1 !== t.targetStyle.indexOf(r[o]) || c(t.targetStyles, r[o])) && r.getPropertyValue(r[o]) && (n += r[o] + ":" + r.getPropertyValue(r[o]) + ";");
                ...
                return n
            }(r, e), e.header && s(e.printableElement, e), f.send(e, t)) : window.console.error("Invalid HTML element id: " + e.printable)
        };
        var g = function (e, t) {
            ...
            })), e.header && s(e.printableElement, e), f.send(e, t)
        };
        ...
        var E = function (e, t) {
            if ("object" !== v(e.printable)) throw new Error("Invalid javascript data object (JSON).");
            ...
            e.properties = e.properties.map((function (t) {
                return {
                    field: "object" === v(t) ? t.field : t,
                    displayName: "object" === v(t) ? t.displayName : t,
                    columnSize: "object" === v(t) && t.columnSize ? t.columnSize + ";" : 100 / e.properties.length + "%;"
                }
            })), e.printableElement = document.createElement("div"), e.header && s(e.printableElement, e), e.printableElement.innerHTML += function (e) {
                var t = e.printable, n = e.properties, r = '<table style="border-collapse: collapse; width: 100%;">';
                ...
                for (var i = 0; i < t.length; i++) {
                    ...
                    for (var a = 0; a < n.length; a++) {
                        var l = t[i], c = n[a].field.split(".");
                        if (c.length > 1) for (var s = 0; s < c.length; s++) l = l[c[s]]; else l = l[n[a].field];
        ...
        var x = ["pdf", "html", "image", "json", "raw-html"], C = function () {
            var e = {
                printable: null,
            ...
            switch (S(t)) {
                ...
                case"object":
                    ...
                    break;
                default:
                    throw new Error('Unexpected argument type! Expected "string" or "object", got ' + S(t))
            }
            if (!e.printable) throw new Error("Missing printable information.");
            if (!e.type || "string" != typeof e.type || -1 === x.indexOf(e.type.toLowerCase())) throw new Error("Invalid print type. Available types are: pdf, html, image and json.");
            e.showModal && a.show(e), e.onLoadingStart && e.onLoadingStart();
            var r = document.getElementById(e.frameId);
            r && r.parentNode.removeChild(r);
            var i = document.createElement("iframe");
            switch (o.isFirefox() ? i.setAttribute("style", "width: 1px; height: 100px; position: fixed; left: 0; top: 0; opacity: 0; border-width: 0; margin: 0; padding: 0") : i.setAttribute("style", "visibility: hidden; height: 0; width: 0; position: absolute; border: 0"), i.setAttribute("id", e.frameId), "pdf" !== e.type && (i.srcdoc = "<html><head><title>" + e.documentTitle + "</title>", e.css && (Array.isArray(e.css) || (e.css = [e.css]), e.css.forEach((function (e) {
                i.srcdoc += '<link rel="stylesheet" href="' + e + '">'
            }))), i.srcdoc += "</head><body></body></html>"), e.type) {
                case"pdf":
                    if (o.isIE()) try {
        ...
        "undefined" != typeof window && (window.printJS = C);
        t["default"] = C
    }])["default"]
}));
